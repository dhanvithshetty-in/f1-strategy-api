...
export const Slider_slider_8dc4b0ec2ac45496c7e6426445275b67 = memo(({children}) => {
...
const on_value_commit_eeedccd452482aaf6012ef054f0d3515 = useCallback(((_ev_0) => (addEvents([(ReflexEvent("reflex___state____state.f1_strategy_api___f1_strategy_api____dashboard_state.set_fuel_load", ({ ["val"] : _ev_0 }), ({  })))], [_ev_0], ({  })))), [addEvents, ReflexEvent])
    ...
    return(
        jsx(RadixThemesSlider,{color:"gray",css:({ ["width"] : "100%" }),defaultValue:[100],max:110,min:5,onValueCommit:on_value_commit_eeedccd452482aaf6012ef054f0d3515,size:"1",width:"100%"},)
    )
});
