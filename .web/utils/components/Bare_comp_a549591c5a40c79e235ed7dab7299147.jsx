...
export const Bare_comp_a549591c5a40c79e235ed7dab7299147 = memo(({children}) => {
    ...
    return(
        (reflex___state____state__f1_strategy_api___f1_strategy_api____dashboard_state.tyre_life_rx_state_+" Laps")
    )
});
